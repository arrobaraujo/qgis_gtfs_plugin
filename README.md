...
[![Version](https://img.shields.io/badge/version-0.3.2-blue.svg)](https://plugins.qgis.org/plugins/qgis_gtfs_plugin/)
...
- Every new **Tag** (e.g., `0.3.2`) triggers a workflow that validates metadata and automatically publishes to the official QGIS repository.
